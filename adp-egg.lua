...
Section:NewDropdown("choose egg", "DropdownInf", {"urban_2023_egg", "mythic_egg", "woodland_egg", "cracked_egg", "regular_pet_egg", "royal_egg", "retired_egg", "seasia_2023_egg"}, function(buyegg)
    print(buyegg)
    buyegg1 = buyegg
end)
